let minRangeValueGap = 6;
      ...
      const rangeInput = document.querySelectorAll(".input-amount");
      const rangePercent = 150;
      ...
      const setMinValueOutput = () => {
        ...
        minval.innerHTML = formatCurrencyAmount(rangeInput[0].value,'USD');
      };
      const setMaxValueOutput = () => {
        maxRange = parseInt(rangeInput[1].value);
        maxval.innerHTML = formatCurrencyAmount(rangeInput[1].value,'USD');
      };
